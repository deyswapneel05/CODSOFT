...
class TaskManager:
    def __init__(self, root):
        ...
        root.geometry("670x500+580+280")
        root.resizable(0, 0)
        root.configure(bg="#aeff00")

        # Frame
        self.functions_frame = Frame(root, bg="#aeff00")
    ...
    def create_widgets(self):
        ...
        self.task_field.place(x=175, y=50)

        Button(
            self.functions_frame, text="Add", width=15,
            bg='#a245ff', font=("Sans serif", "15", "bold"),
